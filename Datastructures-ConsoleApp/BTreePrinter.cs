...
{
    /// <summary>
    /// taken from stackoverflow: https://stackoverflow.com/a/36496436 
    /// My Node class is called 'NodeInt', if yours has a different name, rename NodeInt below.
    /// </summary>
    public static class BTreePrinter
    {
        ...
        public static void Print<T>(this BSTNode root, int topMargin = 2, int leftMargin = 2)
        {
            if (root == null) return;
